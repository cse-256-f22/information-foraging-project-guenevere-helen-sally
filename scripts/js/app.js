...
function setupSticky() {
    ...
    var sticky = (_a = header) === null || _a === void 0 ? void 0 : _a.offsetTop;
    // Add the sticky class to the header when you reach its scroll position. Remove "sticky" when you leave the scroll position
    function myFunction() {
        var _a, _b;
        if (sticky != null && window.pageYOffset > sticky) {
            (_a = header) === null || _a === void 0 ? void 0 : _a.classList.add("sticky");
        }
        else {
            (_b = header) === null || _b === void 0 ? void 0 : _b.classList.remove("sticky");
        }
    }
}
